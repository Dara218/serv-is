    ...
    @include('partials.navbar')
        ...
        <div class="px-16 my-24">
            ...
            <div class="mt-12 flex flex-col items-center gap-8">
                ...
                <div id="toast-warning" class="unsaved-changes-el fixed flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow top-20 right-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert" style="display: none;">
