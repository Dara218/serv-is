        ...
        <div class="px-16 my-24">
            ...
            <div class="mt-12 flex flex-col items-center text-center gap-8">
                <div class="w-full md:w-1/2 flex flex-col gap-6">
                    ...
                    <button type="button" class="mt-6 bg-slate-600 text-white rounded cursor-pointer py-2 px-4 hover:bg-slate-800">Book Provider</button>
                ...
                <div class="flex justify-end">
                    <img src="" alt="">
                    <div>
                        <span class="font-semibold">Customer Review</span>
