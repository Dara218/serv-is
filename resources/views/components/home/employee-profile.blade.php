        ...
        <div class="px-16 my-24">
            ...
            <div class="mt-12 flex flex-col items-center text-center gap-8">
                <div class="w-full md:w-1/2 flex flex-col gap-6">
                    ...
                    {{-- @dd($user) --}}
                    <div class="flex flex-col items-center gap-2 rounded-md bg-slate-100 p-8">
                        ...
                        <button type="button" class="w-full mt-6 bg-slate-500 text-white rounded cursor-pointer py-2 px-4 hover:bg-slate-800">Book Provider</button>
                    </div>
                </div>
                    ...
                    <div class="flex gap-4 relative">
                        ...
                        <div>
                            <div class="flex flex-col gap-1 mb-4">
                                <span class="text-left">Nicole Bautista</span>
