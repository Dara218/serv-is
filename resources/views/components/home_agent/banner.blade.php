@if (Auth::check() && Auth::user()->user_type == 2 && $agentservice)
    <div id="sticky-banner" tabindex="-1" class="fixed top-0 left-0 z-50 flex justify-between w-full p-4 border-b border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        <div class="flex items-center mx-auto">
            <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                ...
                <span>Hello {{ Auth::user()->username }}! You don't have a title on your service. <a href="#" class="inline font-medium text-blue-600 underline dark:text-blue-500 underline-offset-2 decoration-600 dark:decoration-500 decoration-solid hover:no-underline btn-add-service-title">Add here.</a></span>
            </p>
        </div>
